...
public class TimSortTestUtils{
	...
	private TimSortTestUtils(int len){
	...
	private void runsCorrectWorstCase(int len){
		...
		long runningTotal = Math.min(len, minRun);
	...
	public static Integer[] worstCase(int length){
		TimSortTestUtils t = new TimSortTestUtils(length);
