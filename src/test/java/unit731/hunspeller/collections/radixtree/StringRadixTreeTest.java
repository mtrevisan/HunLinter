...
public class StringRadixTreeTest{
	...
	public void testPrepare(){
		...
		Assert.assertEquals("digraph automaton {\n\tgraph [rankdir=LR];\n\t3524 -> 10368 [label=t, weight=100, style=bold];\n\t3524 -> 206321529 [label=rest, weight=100, style=bold];\n\t10368 -> 5710790 [label=ank, weight=100, style=bold];\n\t10368 -> 9483 [label=e, weight=100, style=bold];\n\t9483 -> 220661 [label=st, weight=100, style=bold];\n\t9483 -> 211517 [label=nt, weight=100, style=bold];\n\t211517 -> 5947280 [label=est, weight=100, style=bold];\n\t3524 [shape=circle, label=\"\"];\n\t10368 [shape=circle, label=\"\"];\n\t206321529 [shape=doublecircle, label=\"\"];\n\t5710790 [shape=doublecircle, label=\"\"];\n\t9483 [shape=circle, label=\"\"];\n\t220661 [shape=doublecircle, label=\"\"];\n\t211517 [shape=doublecircle, label=\"\"];\n\t5947280 [shape=doublecircle, label=\"\"];\n}", representation);
