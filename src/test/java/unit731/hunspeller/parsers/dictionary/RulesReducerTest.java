...
//			"PFX .0 0 re [aàbcdđeéèfgiíklƚmnoòpstŧuúvx]"
			...
			"PFX .0 0 re ƚ",
			"PFX .0 0 ar [^ƚ]",
			"PFX .0 0 re [aàbcdđeéèfgiíklmnoòpstŧuúvx]",
			"PFX .0 0 ra [àbcdđeéèfgiíklƚmnoòpstŧuúvx]"
		);
//		Assertions.assertEquals(expectedRules, rules);
