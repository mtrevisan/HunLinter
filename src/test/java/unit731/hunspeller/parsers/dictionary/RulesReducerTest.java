	...
	*/
	...
	public void case13() throws IOException{
		...
		Set<LineEntry> expectedCompactedRules = SetHelper.setOf(
			...
			new LineEntry("derò", "sion", "nderò", Arrays.asList("estenderò", "enderò, sospenderò, espanderò, suspenderò, tenderò")),
			new LineEntry("r", "sion", "[^ei]r", Arrays.asList("kavar", "ermentar, notar, sastufar, strologar, aplikar, traxlokar, komodar, permutar, suparar, komunegar, spekular, kostipar, velar, destinar, eskorporar, danar, konmixerar, tribolar, vokar, markar, sagurar, piñorar, stelar, presixar, lamentar, sonorixar", "idar, sostentar, subordenar, liberar, oparar, versar, xenarar, prosimar, koniugar, klasifegar, kuantifegar, tonar, sklamar, vixitar, torefar, mexurar, koordenar, konvokar, bitar, numarar, reputar, satusfar, putrefar, insinuar, intimar, edukar, sinserar, peñorar, naturalixar, vendegar, esterminar, valutar, sekurar, ostentar, ultimar", "rankar, trobolar, simular, kolaudar, termenar, krear, setar, akuxar, legar, oblar, sindikar, stilar, soportar, konmixarar, verifegar, opinar, privar, ventar, xenerar, provar, torbolar, saludar, servar, perlustrar, solevar, parar, ativar, mutar, segurar, sospetar, autorixar, provokar, prexentar, satisfar, exentar, notifegar, artikolar, legalixar, piegar, mormolar, alterar, numerar, ubigar, luminar, vibrar, sorafar, remunerar, binar, spetorar, salutar, ordenar, redar, sinsierar, estermenar, prevarikar, trasformar, realixar, skriturar, skorporar, votar, raprexar, eskavar, ministrar, sitar, sarvar, saluar, malversar, skalinar, terminar, vasinar", "ar, desimilar, vidimar, ondar, interogar, augumentar, emular, strukar, mansipar, rasionar, levar, malfar, mirar, palpitar, deputar, variar, operar, exborsar, mormorar, tesar, konsumar, tratar", "etar, salvar, spesifegar, xetar, limitar, depoxitar, sikurar, legrar, orar, traversar, pernotar, identifegar, radar, dexertar, rafinar, asimilar, obligar, straxordenar, rapatumar, partesipar, superar, ostinar, strakolar, subarendar, vokalixar", "isar, suplegar, esklamar, inkonbinar", "regar, turbular, separar, kanselar, cetar, manipolar, revokar, sigurar", "iltrar, supurar", "ormar, balotar, interpretar, kolar, xrenar, stalar, elevar, varsar, sodisfar, kapitolar, skaldar, deletar, proar, panixar, substentar, legalidar, iluminar, kontaminar, libarar, malvarsar, examinar, suporar, pelar, espurgar, palatixar, mortifegar, kalsinar, soporar, tentar, nomenar, exaltar, exortar, rivar, butar, sperar, mixurar, senplifegar, situar, sistemar, testar, xmenbrar, strolegar, tranxar, negar")),
			...
			new LineEntry("xerò", "sion", "[^r]xerò", Arrays.asList("duxerò, elexerò, estraxerò, lexerò", "axerò, korexerò, aflixerò, struxerò, produxerò, introduxerò")),
