		...
		if(lastDataBlock.isFull()){
			...
			if(lastSuperBlock.isFull()){
				if(lastSuperBlock.isEven())
					...
					lastSuperBlock = new SuperBlock(lastSuperBlock.isEven() ^ true, lastSuperBlock.maxNumberOfDataBlocks, lastSuperBlock.maxNumberOfElementsPerBlock * 2, 0);
				else
					...
					// This new superBlock currently has no Block in it.
					lastSuperBlock = new SuperBlock(lastSuperBlock.isEven() ^ true, lastSuperBlock.maxNumberOfDataBlocks * 2, lastSuperBlock.maxNumberOfElementsPerBlock, 0);
			}
		...
		if(numberOfEmptyDataBlocks == 2){
			...
			if(lastSuperBlock.isEmpty()){
				if(lastSuperBlock.isEven())
					...
					lastSuperBlock = new SuperBlock(lastSuperBlock.isEven() ^ true, lastSuperBlock.maxNumberOfDataBlocks / 2, lastSuperBlock.maxNumberOfElementsPerBlock, lastSuperBlock.maxNumberOfDataBlocks / 2);
				else
					...
					// This previous superBlock currently is full of Blocks.
					lastSuperBlock = new SuperBlock(lastSuperBlock.isEven() ^ true, lastSuperBlock.maxNumberOfDataBlocks, lastSuperBlock.maxNumberOfElementsPerBlock / 2, lastSuperBlock.maxNumberOfDataBlocks);
			}
		}
	}
