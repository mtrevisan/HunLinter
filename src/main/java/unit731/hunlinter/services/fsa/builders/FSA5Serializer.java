 ...
 */
public class FSA5Serializer implements FSASerializer{
	 ...
	 * Supported flags.
	 */
	private final static EnumSet<FSAFlags> flags = EnumSet.of(FSAFlags.NUMBERS, FSAFlags.SEPARATORS, FSAFlags.FLEXIBLE, FSAFlags.STOPBIT, FSAFlags.NEXTBIT);
