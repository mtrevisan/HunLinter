...
public class DictionaryCorrectnessCheckerVEC extends DictionaryCorrectnessChecker{
	...
	private static final MessageFormat WORD_CANNOT_HAVE_V_IU_V = new MessageFormat("{0} cannot have [aeiou][iu][aeiou]");
	private static final MessageFormat WORD_CANNOT_HAVE_NOT_V_IU_DIERESIS_V = new MessageFormat("{0} cannot have [^aeiou][ïü][^aeiou]");
