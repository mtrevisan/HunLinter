...
public class TreeNode<S, H, V>{
	...
	private Map<H, TreeNode<S, H, V>> children;
	...
	/**
	 * Splits this node at the given relative index and returns the TreeNode with
	 * the sequence starting at index. The returned TreeNode has this node's
	 * sequence, value, and children. The returned TreeNode is also the only
	 ...
	 */
	public TreeNode<S, H, V> split(int index, V value, TreeSequencer<S, H> sequencer){
