...
//private final Trie<String[], String, List<AffixEntry>> prefixEntries;
//private final Trie<String[], String, List<AffixEntry>> suffixEntries;
...
//public RuleEntry(boolean isSuffix, String combineable, List<AffixEntry> entries, Trie<String[], String, List<AffixEntry>> prefixEntries, Trie<String[], String, List<AffixEntry>> suffixEntries){
//	Objects.requireNonNull(combineable);
