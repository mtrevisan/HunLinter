...
//		CANNOT_CONTAINS_ACCENT.add(COLLECTIVE_SUBSTANTIVES_RULE_VANISHING_EL);
	...
	private static final class MatcherEntry2{
		...
		MatcherEntry2(List<String> continuationFlags, String messagePattern, Object ... arguments){
	...
	private static final Set<MatcherEntry2> MISMATCH_CHECKS_MUST_CONTAINS_LH = new HashSet<>();
	private static final Set<MatcherEntry2> MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH = new HashSet<>();
	private static final Set<MatcherEntry2> MISMATCH_CHECKS_MUST_CONTAINS_DH_OR_TH = new HashSet<>();
	static{
		if(false){
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(VERB_1ST_RULE_NON_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, VERB_1ST_RULE_NON_VANISHING_EL, VERB_1ST_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(VERB_1ST_RULE_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, VERB_1ST_RULE_VANISHING_EL, VERB_1ST_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(VERB_2ND_RULE_NON_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, VERB_2ND_RULE_NON_VANISHING_EL, VERB_2ND_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(VERB_2ND_RULE_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, VERB_2ND_RULE_VANISHING_EL, VERB_2ND_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(VERB_3RD_IS_RULE_NON_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, VERB_3RD_IS_RULE_NON_VANISHING_EL, VERB_3RD_IS_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(VERB_3RD_IS_RULE_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, VERB_3RD_IS_RULE_VANISHING_EL, VERB_3RD_IS_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(VERB_3RD_NO_IS_RULE_NON_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, VERB_3RD_NO_IS_RULE_NON_VANISHING_EL, VERB_3RD_NO_IS_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(VERB_3RD_NO_IS_RULE_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, VERB_3RD_NO_IS_RULE_VANISHING_EL, VERB_3RD_NO_IS_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(VERB_3RD_BOTH_IS_RULE_NON_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, VERB_3RD_BOTH_IS_RULE_NON_VANISHING_EL, VERB_3RD_BOTH_IS_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(VERB_3RD_BOTH_IS_RULE_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, VERB_3RD_BOTH_IS_RULE_VANISHING_EL, VERB_3RD_BOTH_IS_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(VERB_DAR_RULE_NON_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, VERB_DAR_RULE_NON_VANISHING_EL, VERB_DAR_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(VERB_DAR_RULE_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, VERB_DAR_RULE_VANISHING_EL, VERB_DAR_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(VERB_TOLER_RULE_NON_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, VERB_TOLER_RULE_NON_VANISHING_EL, VERB_TOLER_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(VERB_TOLER_RULE_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, VERB_TOLER_RULE_VANISHING_EL, VERB_TOLER_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(VERB_DIXER_RULE_NON_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, VERB_DIXER_RULE_NON_VANISHING_EL, VERB_DIXER_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(VERB_DIXER_RULE_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, VERB_DIXER_RULE_VANISHING_EL, VERB_DIXER_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(PROCOMPLEMENTAR_VERB_DEFINITE_RULE_NON_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, PROCOMPLEMENTAR_VERB_DEFINITE_RULE_NON_VANISHING_EL, PROCOMPLEMENTAR_VERB_DEFINITE_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(PROCOMPLEMENTAR_VERB_DEFINITE_RULE_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, PROCOMPLEMENTAR_VERB_DEFINITE_RULE_VANISHING_EL, PROCOMPLEMENTAR_VERB_DEFINITE_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(PROCOMPLEMENTAR_VERB_INDEFINITE_RULE_NON_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, PROCOMPLEMENTAR_VERB_INDEFINITE_RULE_NON_VANISHING_EL, PROCOMPLEMENTAR_VERB_INDEFINITE_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(PROCOMPLEMENTAR_VERB_INDEFINITE_RULE_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, PROCOMPLEMENTAR_VERB_INDEFINITE_RULE_VANISHING_EL, PROCOMPLEMENTAR_VERB_INDEFINITE_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(PROCOMPLEMENTAR_VERB_IMPERATIVE_RULE_NON_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, PROCOMPLEMENTAR_VERB_IMPERATIVE_RULE_NON_VANISHING_EL, PROCOMPLEMENTAR_VERB_IMPERATIVE_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(PROCOMPLEMENTAR_VERB_IMPERATIVE_RULE_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, PROCOMPLEMENTAR_VERB_IMPERATIVE_RULE_VANISHING_EL, PROCOMPLEMENTAR_VERB_IMPERATIVE_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(INTERROGATIVES_3RD_PERSON_RULE_NON_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, INTERROGATIVES_3RD_PERSON_RULE_NON_VANISHING_EL, INTERROGATIVES_3RD_PERSON_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(INTERROGATIVES_3RD_PERSON_RULE_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, INTERROGATIVES_3RD_PERSON_RULE_VANISHING_EL, INTERROGATIVES_3RD_PERSON_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(INTERROGATIVES_3RD_PERSON_CONDITIONAL_RULE_NON_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, INTERROGATIVES_3RD_PERSON_CONDITIONAL_RULE_NON_VANISHING_EL, INTERROGATIVES_3RD_PERSON_CONDITIONAL_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(INTERROGATIVES_3RD_PERSON_CONDITIONAL_RULE_VANISHING_EL),
				MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, INTERROGATIVES_3RD_PERSON_CONDITIONAL_RULE_VANISHING_EL, INTERROGATIVES_3RD_PERSON_CONDITIONAL_RULE_NON_VANISHING_EL));
		}

		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(FINAL_SONORIZATION_RULE),
			MatcherEntry2.CANNOT_USE_RULE_WITH_LH, FINAL_SONORIZATION_RULE));

		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(DEVERBAL_NOMINALS_MENTO_RULE_NON_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, DEVERBAL_NOMINALS_MENTO_RULE_NON_VANISHING_EL, DEVERBAL_NOMINALS_MENTO_RULE_VANISHING_EL));
		MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(DEVERBAL_NOMINALS_MENTO_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, DEVERBAL_NOMINALS_MENTO_RULE_VANISHING_EL, DEVERBAL_NOMINALS_MENTO_RULE_NON_VANISHING_EL));

		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(PLANTS_AND_CRAFTS_RULE_NON_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, PLANTS_AND_CRAFTS_RULE_NON_VANISHING_EL, PLANTS_AND_CRAFTS_RULE_VANISHING_EL));
		MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(PLANTS_AND_CRAFTS_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, PLANTS_AND_CRAFTS_RULE_VANISHING_EL, PLANTS_AND_CRAFTS_RULE_NON_VANISHING_EL));

		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(DEVERBAL_NOMINALS_THION_RULE_NON_VANISHING_EL, DEVERBAL_NOMINALS_SION_RULE_NON_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, DEVERBAL_NOMINALS_SION_RULE_NON_VANISHING_EL, DEVERBAL_NOMINALS_SION_RULE_VANISHING_EL));
		MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(DEVERBAL_NOMINALS_SION_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, DEVERBAL_NOMINALS_THION_RULE_NON_VANISHING_EL, DEVERBAL_NOMINALS_SION_RULE_NON_VANISHING_EL, DEVERBAL_NOMINALS_SION_RULE_VANISHING_EL));

		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(DEVERBAL_NOMINALS_IXMO_RULE_NON_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, DEVERBAL_NOMINALS_IXMO_RULE_NON_VANISHING_EL, DEVERBAL_NOMINALS_IXMO_RULE_VANISHING_EL));
		MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(DEVERBAL_NOMINALS_IXMO_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, DEVERBAL_NOMINALS_IXMO_RULE_VANISHING_EL, DEVERBAL_NOMINALS_IXMO_RULE_NON_VANISHING_EL));

		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(ADVERB_MENTE_RULE_NON_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, ADVERB_MENTE_RULE_NON_VANISHING_EL, ADVERB_MENTE_RULE_VANISHING_EL));
		MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(ADVERB_MENTE_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, ADVERB_MENTE_RULE_VANISHING_EL, ADVERB_MENTE_RULE_NON_VANISHING_EL));

		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(DIMINUTIVE_ETO_RULE_NON_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, DIMINUTIVE_ETO_RULE_NON_VANISHING_EL, DIMINUTIVE_ETO_RULE_VANISHING_EL));
		MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(DIMINUTIVE_ETO_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, DIMINUTIVE_ETO_RULE_VANISHING_EL, DIMINUTIVE_ETO_RULE_NON_VANISHING_EL));
		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(DIMINUTIVE_EL_RULE_NON_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, DIMINUTIVE_EL_RULE_NON_VANISHING_EL, DIMINUTIVE_EL_RULE_VANISHING_EL));
		MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(DIMINUTIVE_EL_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, DIMINUTIVE_EL_RULE_VANISHING_EL, DIMINUTIVE_EL_RULE_NON_VANISHING_EL));

		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(AUGMENTATIVE_OTO_RULE_NON_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, AUGMENTATIVE_OTO_RULE_NON_VANISHING_EL, AUGMENTATIVE_OTO_RULE_VANISHING_EL));
		MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(AUGMENTATIVE_OTO_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, AUGMENTATIVE_OTO_RULE_VANISHING_EL, AUGMENTATIVE_OTO_RULE_NON_VANISHING_EL));
		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(AUGMENTATIVE_ON_RULE_NON_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, AUGMENTATIVE_ON_RULE_NON_VANISHING_EL, AUGMENTATIVE_ON_RULE_VANISHING_EL));
		MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(AUGMENTATIVE_ON_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, AUGMENTATIVE_ON_RULE_VANISHING_EL, AUGMENTATIVE_ON_RULE_NON_VANISHING_EL));
		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(AUGMENTATIVE_ON_A_RULE_NON_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, AUGMENTATIVE_ON_A_RULE_NON_VANISHING_EL, AUGMENTATIVE_ON_A_RULE_VANISHING_EL));
		MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(AUGMENTATIVE_ON_A_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, AUGMENTATIVE_ON_A_RULE_VANISHING_EL, AUGMENTATIVE_ON_A_RULE_NON_VANISHING_EL));

		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(ETHA_RULE_NON_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, ETHA_RULE_NON_VANISHING_EL, ESA_RULE_VANISHING_EL));
		MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(ESA_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, ESA_RULE_VANISHING_EL, ETHA_RULE_NON_VANISHING_EL));
		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(ITHIA_RULE_NON_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, ITHIA_RULE_NON_VANISHING_EL, ISIA_RULE_VANISHING_EL));
		MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(ISIA_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_NON_LH_USE_INSTEAD, ISIA_RULE_VANISHING_EL, ITHIA_RULE_NON_VANISHING_EL));

		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(PEJORATIVE_ATHO_RULE_NON_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, PEJORATIVE_ATHO_RULE_NON_VANISHING_EL, PEJORATIVE_ASO_RULE_VANISHING_EL));
		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry2(Arrays.asList(PEJORATIVE_ATO_RULE_NON_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_LH_USE_INSTEAD, PEJORATIVE_ATO_RULE_NON_VANISHING_EL, PEJORATIVE_ATO_RULE_VANISHING_EL));


		MISMATCH_CHECKS_MUST_CONTAINS_DH_OR_TH.add(new MatcherEntry2(Arrays.asList(PLANTS_AND_CRAFTS_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_TH_OR_DH_USE_INSTEAD, PLANTS_AND_CRAFTS_RULE_VANISHING_EL, PLANTS_AND_CRAFTS_RULE_NON_VANISHING_EL));
		MISMATCH_CHECKS_MUST_CONTAINS_DH_OR_TH.add(new MatcherEntry2(Arrays.asList(DEVERBAL_NOMINALS_MENTO_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_TH_OR_DH_USE_INSTEAD, DEVERBAL_NOMINALS_MENTO_RULE_VANISHING_EL, DEVERBAL_NOMINALS_MENTO_RULE_NON_VANISHING_EL));

		MISMATCH_CHECKS_MUST_CONTAINS_DH_OR_TH.add(new MatcherEntry2(Arrays.asList(DEVERBAL_NOMINALS_SION_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_TH_OR_DH_USE_INSTEAD, DEVERBAL_NOMINALS_SION_RULE_VANISHING_EL, DEVERBAL_NOMINALS_THION_RULE_NON_VANISHING_EL));
		MISMATCH_CHECKS_MUST_CONTAINS_DH_OR_TH.add(new MatcherEntry2(Arrays.asList(DEVERBAL_NOMINALS_IXMO_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_TH_OR_DH_USE_INSTEAD, DEVERBAL_NOMINALS_IXMO_RULE_VANISHING_EL, DEVERBAL_NOMINALS_IXMO_RULE_NON_VANISHING_EL));
		MISMATCH_CHECKS_MUST_CONTAINS_DH_OR_TH.add(new MatcherEntry2(Arrays.asList(ADVERB_MENTE_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_TH_OR_DH_USE_INSTEAD, ADVERB_MENTE_RULE_VANISHING_EL, ADVERB_MENTE_RULE_NON_VANISHING_EL));
		MISMATCH_CHECKS_MUST_CONTAINS_DH_OR_TH.add(new MatcherEntry2(Arrays.asList(DIMINUTIVE_ETO_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_TH_OR_DH_USE_INSTEAD, DIMINUTIVE_ETO_RULE_VANISHING_EL, DIMINUTIVE_ETO_RULE_NON_VANISHING_EL));
		MISMATCH_CHECKS_MUST_CONTAINS_DH_OR_TH.add(new MatcherEntry2(Arrays.asList(DIMINUTIVE_EL_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_TH_OR_DH_USE_INSTEAD, DIMINUTIVE_EL_RULE_VANISHING_EL, DIMINUTIVE_EL_RULE_NON_VANISHING_EL));
		MISMATCH_CHECKS_MUST_CONTAINS_DH_OR_TH.add(new MatcherEntry2(Arrays.asList(AUGMENTATIVE_OTO_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_TH_OR_DH_USE_INSTEAD, AUGMENTATIVE_OTO_RULE_VANISHING_EL, AUGMENTATIVE_OTO_RULE_NON_VANISHING_EL));
		MISMATCH_CHECKS_MUST_CONTAINS_DH_OR_TH.add(new MatcherEntry2(Arrays.asList(AUGMENTATIVE_ON_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_TH_OR_DH_USE_INSTEAD, AUGMENTATIVE_ON_RULE_VANISHING_EL, AUGMENTATIVE_ON_RULE_NON_VANISHING_EL));
		MISMATCH_CHECKS_MUST_CONTAINS_DH_OR_TH.add(new MatcherEntry2(Arrays.asList(AUGMENTATIVE_ON_A_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_TH_OR_DH_USE_INSTEAD, AUGMENTATIVE_ON_A_RULE_VANISHING_EL, AUGMENTATIVE_ON_A_RULE_NON_VANISHING_EL));
		MISMATCH_CHECKS_MUST_CONTAINS_DH_OR_TH.add(new MatcherEntry2(Arrays.asList(PEJORATIVE_ATO_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_TH_OR_DH_USE_INSTEAD, PEJORATIVE_ATO_RULE_VANISHING_EL, PEJORATIVE_ATO_RULE_NON_VANISHING_EL));
		MISMATCH_CHECKS_MUST_CONTAINS_DH_OR_TH.add(new MatcherEntry2(Arrays.asList(PEJORATIVE_ASO_RULE_VANISHING_EL),
			MatcherEntry2.CANNOT_USE_RULE_WITH_TH_OR_DH_USE_INSTEAD, PEJORATIVE_ASO_RULE_VANISHING_EL, PEJORATIVE_ASO_RULE_NON_VANISHING_EL));
	}
	...
	private final Map<String, Set<MatcherEntry>> mustNotAdmit = new HashMap<>();
...
//				ciuiCheck(subword, production);
	...
	private void incompatibilityCheck(Production production) throws IllegalArgumentException{
		...
		continuationFlagIncompatibilityCheck(production, mustNotAdmit);
	...
	private void variantIncompatibilityCheck(Production production, Set<MatcherEntry2> checks, String... contains)
			throws IllegalArgumentException{
		if(StringUtils.containsAny(production.getWord(), contains))
			for(MatcherEntry2 entry : checks)
				entry.match(production);
	}
