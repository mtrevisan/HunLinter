...
public class DictionaryParserVEC extends DictionaryParser{
	...
	static{
		if(ENABLE_VERB_CHECK){
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry(VANISHING_L + VERB_1ST_RULE_NON_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_LH, VERB_1ST_RULE_NON_VANISHING_EL, VERB_1ST_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry(NON_VANISHING_L + VERB_1ST_RULE_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_NON_LH, VERB_1ST_RULE_VANISHING_EL, VERB_1ST_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry(VANISHING_L + VERB_2ND_RULE_NON_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_LH, VERB_2ND_RULE_NON_VANISHING_EL, VERB_2ND_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry(NON_VANISHING_L + VERB_2ND_RULE_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_NON_LH, VERB_2ND_RULE_VANISHING_EL, VERB_2ND_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry(VANISHING_L + VERB_3RD_IS_RULE_NON_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_LH, VERB_3RD_IS_RULE_NON_VANISHING_EL, VERB_3RD_IS_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry(NON_VANISHING_L + VERB_3RD_IS_RULE_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_NON_LH, VERB_3RD_IS_RULE_VANISHING_EL, VERB_3RD_IS_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry(VANISHING_L + VERB_3RD_NO_IS_RULE_NON_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_LH, VERB_3RD_NO_IS_RULE_NON_VANISHING_EL, VERB_3RD_NO_IS_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry(NON_VANISHING_L + VERB_3RD_NO_IS_RULE_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_NON_LH, VERB_3RD_NO_IS_RULE_VANISHING_EL, VERB_3RD_NO_IS_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry(VANISHING_L + VERB_3RD_BOTH_IS_RULE_NON_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_LH, VERB_3RD_BOTH_IS_RULE_NON_VANISHING_EL, VERB_3RD_BOTH_IS_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry(NON_VANISHING_L + VERB_3RD_BOTH_IS_RULE_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_NON_LH, VERB_3RD_BOTH_IS_RULE_VANISHING_EL, VERB_3RD_BOTH_IS_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry(VANISHING_L + VERB_DAR_RULE_NON_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_LH, VERB_DAR_RULE_NON_VANISHING_EL, VERB_DAR_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry(NON_VANISHING_L + VERB_DAR_RULE_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_NON_LH, VERB_DAR_RULE_VANISHING_EL, VERB_DAR_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry(VANISHING_L + VERB_TOLER_RULE_NON_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_LH, VERB_TOLER_RULE_NON_VANISHING_EL, VERB_TOLER_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry(NON_VANISHING_L + VERB_TOLER_RULE_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_NON_LH, VERB_TOLER_RULE_VANISHING_EL, VERB_TOLER_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry(VANISHING_L + VERB_DIXER_RULE_NON_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_LH, VERB_DIXER_RULE_NON_VANISHING_EL, VERB_DIXER_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry(NON_VANISHING_L + VERB_DIXER_RULE_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_NON_LH, VERB_DIXER_RULE_VANISHING_EL, VERB_DIXER_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry(VANISHING_L + PROCOMPLEMENTAR_VERB_DEFINITE_RULE_NON_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_LH, PROCOMPLEMENTAR_VERB_DEFINITE_RULE_NON_VANISHING_EL, PROCOMPLEMENTAR_VERB_DEFINITE_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry(NON_VANISHING_L + PROCOMPLEMENTAR_VERB_DEFINITE_RULE_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_NON_LH, PROCOMPLEMENTAR_VERB_DEFINITE_RULE_VANISHING_EL, PROCOMPLEMENTAR_VERB_DEFINITE_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry(VANISHING_L + PROCOMPLEMENTAR_VERB_INDEFINITE_RULE_NON_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_LH, PROCOMPLEMENTAR_VERB_INDEFINITE_RULE_NON_VANISHING_EL, PROCOMPLEMENTAR_VERB_INDEFINITE_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry(NON_VANISHING_L + PROCOMPLEMENTAR_VERB_INDEFINITE_RULE_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_NON_LH, PROCOMPLEMENTAR_VERB_INDEFINITE_RULE_VANISHING_EL, PROCOMPLEMENTAR_VERB_INDEFINITE_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry(VANISHING_L + PROCOMPLEMENTAR_VERB_IMPERATIVE_RULE_NON_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_LH, PROCOMPLEMENTAR_VERB_IMPERATIVE_RULE_NON_VANISHING_EL, PROCOMPLEMENTAR_VERB_IMPERATIVE_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry(NON_VANISHING_L + PROCOMPLEMENTAR_VERB_IMPERATIVE_RULE_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_NON_LH, PROCOMPLEMENTAR_VERB_IMPERATIVE_RULE_VANISHING_EL, PROCOMPLEMENTAR_VERB_IMPERATIVE_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry(VANISHING_L + INTERROGATIVES_3RD_PERSON_RULE_NON_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_LH, INTERROGATIVES_3RD_PERSON_RULE_NON_VANISHING_EL, INTERROGATIVES_3RD_PERSON_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry(NON_VANISHING_L + INTERROGATIVES_3RD_PERSON_RULE_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_NON_LH, INTERROGATIVES_3RD_PERSON_RULE_VANISHING_EL, INTERROGATIVES_3RD_PERSON_RULE_NON_VANISHING_EL));
			MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry(VANISHING_L + INTERROGATIVES_3RD_PERSON_CONDITIONAL_RULE_NON_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_LH, INTERROGATIVES_3RD_PERSON_CONDITIONAL_RULE_NON_VANISHING_EL, INTERROGATIVES_3RD_PERSON_CONDITIONAL_RULE_VANISHING_EL));
			MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry(NON_VANISHING_L + INTERROGATIVES_3RD_PERSON_CONDITIONAL_RULE_VANISHING_EL,
				MatcherEntry.CANNOT_USE_RULE_WITH_NON_LH, INTERROGATIVES_3RD_PERSON_CONDITIONAL_RULE_VANISHING_EL, INTERROGATIVES_3RD_PERSON_CONDITIONAL_RULE_NON_VANISHING_EL));
		}

		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry(VANISHING_L + DEVERBAL_NOMINALS_MENTO_RULE_NON_VANISHING_EL,
			MatcherEntry.CANNOT_USE_RULE_WITH_LH, DEVERBAL_NOMINALS_MENTO_RULE_NON_VANISHING_EL, DEVERBAL_NOMINALS_MENTO_RULE_VANISHING_EL));
		MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry(NON_VANISHING_L + DEVERBAL_NOMINALS_MENTO_RULE_VANISHING_EL,
			MatcherEntry.CANNOT_USE_RULE_WITH_NON_LH, DEVERBAL_NOMINALS_MENTO_RULE_VANISHING_EL, DEVERBAL_NOMINALS_MENTO_RULE_NON_VANISHING_EL));

		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry(VANISHING_L + PLANTS_AND_CRAFTS_RULE_NON_VANISHING_EL,
			MatcherEntry.CANNOT_USE_RULE_WITH_LH, PLANTS_AND_CRAFTS_RULE_NON_VANISHING_EL, PLANTS_AND_CRAFTS_RULE_VANISHING_EL));
		MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry(NON_VANISHING_L + PLANTS_AND_CRAFTS_RULE_VANISHING_EL,
			MatcherEntry.CANNOT_USE_RULE_WITH_NON_LH, PLANTS_AND_CRAFTS_RULE_VANISHING_EL, PLANTS_AND_CRAFTS_RULE_NON_VANISHING_EL));
		...
		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry(VANISHING_L + "[" + DEVERBAL_NOMINALS_THION_RULE_NON_VANISHING_EL + DEVERBAL_NOMINALS_SION_RULE_NON_VANISHING_EL + "]",
			MatcherEntry.CANNOT_USE_RULE_WITH_LH, DEVERBAL_NOMINALS_SION_RULE_NON_VANISHING_EL, DEVERBAL_NOMINALS_SION_RULE_VANISHING_EL));
		MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry(NON_VANISHING_L + DEVERBAL_NOMINALS_SION_RULE_VANISHING_EL,
			MatcherEntry.CANNOT_USE_RULE_WITH_NON_LH, DEVERBAL_NOMINALS_THION_RULE_NON_VANISHING_EL, DEVERBAL_NOMINALS_SION_RULE_NON_VANISHING_EL, DEVERBAL_NOMINALS_SION_RULE_VANISHING_EL));

		MISMATCH_CHECKS_MUST_CONTAINS_LH.add(new MatcherEntry(VANISHING_L + ADVERB_MENTE_RULE_NON_VANISHING_EL,
			MatcherEntry.CANNOT_USE_RULE_WITH_LH, ADVERB_MENTE_RULE_NON_VANISHING_EL, ADVERB_MENTE_RULE_VANISHING_EL));
		MISMATCH_CHECKS_MUST_NOT_CONTAINS_LH.add(new MatcherEntry(NON_VANISHING_L + ADVERB_MENTE_RULE_VANISHING_EL,
			MatcherEntry.CANNOT_USE_RULE_WITH_NON_LH, ADVERB_MENTE_RULE_VANISHING_EL, ADVERB_MENTE_RULE_NON_VANISHING_EL));
	...
	static{
		...
		ADJECTIVE_FIRST_CLASS_MISMATCH_CHECKS.add(new MatcherEntry(Arrays.asList(AUGMENTATIVE_ON_RULE_NON_VANISHING_EL, AUGMENTATIVE_ON_RULE_VANISHING_EL),
			WORD_WITH_RULE_CANNOT_HAVE, ADJECTIVE_FIRST_CLASS_RULE));
		ADJECTIVE_FIRST_CLASS_MISMATCH_CHECKS.add(new MatcherEntry(Arrays.asList(PEJORATIVE_ATO_RULE),
			WORD_WITH_RULE_CANNOT_HAVE, ADJECTIVE_FIRST_CLASS_RULE));
		ADJECTIVE_FIRST_CLASS_MISMATCH_CHECKS.add(new MatcherEntry(Arrays.asList(COLLECTIVE_NOUNS_RULE),
			WORD_WITH_RULE_CANNOT_HAVE, ADJECTIVE_FIRST_CLASS_RULE));
		ADJECTIVE_FIRST_CLASS_MISMATCH_CHECKS.add(new MatcherEntry(Arrays.asList(PEJORATIVE_ATHO_RULE_NON_VANISHING_EL, PEJORATIVE_ATHO_RULE_VANISHING_EL),
			WORD_WITH_RULE_CANNOT_HAVE, ADJECTIVE_FIRST_CLASS_RULE));
	}

	//also V0/)0 - &0/&1
	private static final Set<MatcherEntry> VARIANT_TRANSFORMATION_MISMATCH_CHECKS = new HashSet<>();
	static{
		VARIANT_TRANSFORMATION_MISMATCH_CHECKS.add(new MatcherEntry(Arrays.asList("V0"),
			WORD_WITH_RULE_CANNOT_HAVE, VARIANT_TRANSFORMATIONS_RULE));
		VARIANT_TRANSFORMATION_MISMATCH_CHECKS.add(new MatcherEntry(Arrays.asList("v0"),
			WORD_WITH_RULE_CANNOT_HAVE, VARIANT_TRANSFORMATIONS_RULE));
		VARIANT_TRANSFORMATION_MISMATCH_CHECKS.add(new MatcherEntry(Arrays.asList("T1"),
			WORD_WITH_RULE_CANNOT_HAVE, VARIANT_TRANSFORMATIONS_RULE));
		VARIANT_TRANSFORMATION_MISMATCH_CHECKS.add(new MatcherEntry(Arrays.asList(DIMINUTIVE_ETO_RULE_NON_VANISHING_EL, DIMINUTIVE_ETO_RULE_VANISHING_EL),
			WORD_WITH_RULE_CANNOT_HAVE, VARIANT_TRANSFORMATIONS_RULE));
		VARIANT_TRANSFORMATION_MISMATCH_CHECKS.add(new MatcherEntry(Arrays.asList(AUGMENTATIVE_ON_RULE_NON_VANISHING_EL, AUGMENTATIVE_ON_RULE_VANISHING_EL),
			WORD_WITH_RULE_CANNOT_HAVE, VARIANT_TRANSFORMATIONS_RULE));
	}
