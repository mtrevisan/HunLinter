...
public class CorrectnessChecker{
	...
	protected static final MessageFormat WORD_HAS_NOT_ACCENT = new MessageFormat("Word {0} cannot be generated by the rule {1} because of the missing accent");
	protected static final MessageFormat WORD_HAS_ACCENT = new MessageFormat("Word {0} cannot be generated by the rule {1} because of the present accent");
