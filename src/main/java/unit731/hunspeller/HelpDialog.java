	...
	public HelpDialog(Frame parent){
		...
		lblManagedOptionsTextArea.setText(
			...
			+ "Suggestions:\n"
				+ "REP\n"
			+ "Compounding:\n"
				+ "\tCOMPOUNDRULE, COMPOUNDMIN, COMPOUNDFLAG, ONLYINCOMPOUND, COMPOUNDPERMITFLAG, COMPOUNDFORBIDFLAG, COMPOUNDMORESUFFIXES, COMPOUNDWORDMAX, CHECKCOMPOUNDDUP, CHECKCOMPOUNDREP, CHECKCOMPOUNDCASE, CHECKCOMPOUNDTRIPLE, SIMPLIFIEDTRIPLE\n"
			+ "Affix creation:\n"
				+ "\tPFX, SFX\n"
			+ "Others:\n"
