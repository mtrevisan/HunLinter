...
public class HelpDialog extends JDialog{
	...
	public HelpDialog(Frame parent){
		...
		lblManagedOptionsTextArea.setText(
			...
			+ "Compounding:\n"
			+ "\tCOMPOUNDRULE, COMPOUNDMIN, COMPOUNDFLAG, ONLYINCOMPOUND, COMPOUNDPERMITFLAG, COMPOUNDMORESUFFIXES, COMPOUNDFORBIDFLAG, COMPOUNDWORDMAX, CHECKCOMPOUNDDUP, CIRCUMFIX, CHECKCOMPOUNDTRIPLE, SIMPLIFIEDTRIPLE\n"
			+ "Affix creation:\n"
			+ "\tPFX, SFX\n"
			+ "Others:\n"
