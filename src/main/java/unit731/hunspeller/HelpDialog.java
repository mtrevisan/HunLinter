	...
	public HelpDialog(Frame parent){
		...
		lblManagedOptionsTextArea.setText(
			...
			+ "Suggestions:\n"
				+ "REP\n"
			+ "Compounding:\n"
				+ "\tCOMPOUNDRULE, COMPOUNDMIN, COMPOUNDFLAG, ONLYINCOMPOUND, COMPOUNDPERMITFLAG, COMPOUNDMORESUFFIXES, COMPOUNDFORBIDFLAG, COMPOUNDWORDMAX, CHECKCOMPOUNDDUP, CHECKCOMPOUNDREP, CHECKCOMPOUNDCASE, CHECKCOMPOUNDTRIPLE, SIMPLIFIEDTRIPLE, CIRCUMFIX, FORBIDDENWORD\n"
			+ "Affix creation:\n"
				+ "\tPFX, SFX\n"
			+ "Others:\n"
